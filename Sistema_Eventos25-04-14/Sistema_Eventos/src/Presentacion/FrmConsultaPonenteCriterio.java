 ...
 * @author BEPIS
 */
public class FrmConsultaPonenteCriterio extends javax.swing.JInternalFrame {

    static ResultSet rs = null;
    DefaultTableModel dtm = new DefaultTableModel();
    

    public FrmConsultaPonenteCriterio() {
        initComponents(); 
        agruparBotones();
        cargarTabla();
    }
    ...
    public void agruparBotones(){
        ...
        buttonGroup1.add(btnNacionalidad);
        buttonGroup1.add(rbtnTodos);
    }
    
    public void cargarTabla(){
        String titulos[] = {"Codigo", "Nombres", "Apellidos", "Nacionalidad", "Especialidad", "Foto"};
    ...
    private void initComponents() {
        ...
        btnNacionalidad = new javax.swing.JRadioButton();
        ...
        jLabel1.setText("Consulta de Ponentes  por Criterio");
        ...
        getContentPane().add(btnNacionalidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 100, -1, -1));
    ...
    private void btngenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btngenerarActionPerformed
       ...
       else if (btnNacionalidad.isSelected()){
    ...
    try{
        rs = ponente.consultarPonenteCriterio(Criterio, Busqueda);
    ...
    private javax.swing.JRadioButton btnNacionalidad;
