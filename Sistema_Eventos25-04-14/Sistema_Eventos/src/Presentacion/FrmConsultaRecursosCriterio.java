 ...
 * @author BEPIS
 */
public class FrmConsultaRecursosCriterio extends javax.swing.JInternalFrame {

    static ResultSet rs = null;
    DefaultTableModel dtm = new DefaultTableModel();
    

    public FrmConsultaRecursosCriterio() {
        initComponents(); 
        agruparBotones();
        cargarTabla();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(rbtnPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 100, -1, -1));
    ...
    try{
        rs = recurso.consultarRecursoCriterio(Criterio, Busqueda);
