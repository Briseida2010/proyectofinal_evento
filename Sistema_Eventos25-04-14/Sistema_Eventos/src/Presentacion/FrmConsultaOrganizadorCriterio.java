 ...
 * @author BEPIS
 */
public class FrmConsultaOrganizadorCriterio extends javax.swing.JInternalFrame {

    static ResultSet rs = null;
    DefaultTableModel dtm = new DefaultTableModel();
    

    public FrmConsultaOrganizadorCriterio() {
        initComponents(); 
        agruparBotones();
        cargarTabla();
    }
    ...
    public void cargarTabla(){
        String titulos[] = {"Codigo", "Nombres", "Apellidos", "DNI", "Celular"};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta de Operaciones por Criterio");
        ...
        rbtnDni.setText("DNI");
        getContentPane().add(rbtnDni, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 100, -1, -1));
    ...
    try{
        rs = organizador.consultarOrganizadorCriterio(Criterio, Busqueda);
